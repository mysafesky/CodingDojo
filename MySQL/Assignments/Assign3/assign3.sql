...
-- 1. What query would you run to get all the customers 
-- inside city_id = 312? Your query should return customer 
...
-- 2.What query would you run to get all comedy films? Your 
-- query should return film title, description, release year, 
...
-- actor_id=5? Your query should return the film title, description,
-- and release year.
...
-- the film title, description, release year, rate, and special feature. Hint: You 
...
-- rating, special features, genre, and actor's first name and last name.
